...
class Router extends EventEmitter {
    ...
    onpopstate() {
        // TODO write a unit test on this
        this.populateFromLocation();
        this.emit('change');
    }
    ...
    load(res) {
        ...
        return new Promise(function (resolve) {
            var module = handler(router, res);
            // TODO I'm quite sure this comment will stay forever, but the promise
            // should be resolved asynchronous once the module is actually initialized
            // at the moment there's now way
            resolve(module);
        });
    }
