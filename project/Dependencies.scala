...
object Dependencies {
  ...
  val browsermob = "net.lightbody.bmp" % "browsermob-core" % "2.1.0-beta-1-SNAPSHOT" % "test"
  val browsermobLittleProxy = "net.lightbody.bmp" % "browsermob-core-littleproxy" % "2.1.0-beta-1-SNAPSHOT" % "test"
